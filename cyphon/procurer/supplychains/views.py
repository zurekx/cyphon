...
"""
Defines views for SupplyChains.
"""
...
# from .serializers import SupplyChainSerializer, SupplyChainRunSerializer


# alert.distillery__container__bottle
# supplychain.first_bottle (supplylink__condenser__bottle)

# class SupplyChainViewSet(CustomModelViewSet):
#     """
#     REST API for SupplyChains.
#     """
#     queryset = SupplyChain.objects.all()
#     custom_filter_backends = ['responder.actions.filters.ActionFilterBackend']
#     permission_classes = [IsAuthenticated, ]
#     serializers = {
#         'run': SupplyChainRunSerializer,
#         'default': SupplyChainSerializer
#     }
