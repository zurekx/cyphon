    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default', models.CharField(blank=True, null=True, max_length=255, verbose_name='default value')),
                ...
                ('help_text', models.CharField(blank=True, null=True, max_length=255, verbose_name='help text')),
                ('verbose_name', models.CharField(blank=True, null=True, max_length=255, verbose_name='verbose name')),
            ],
            options={
